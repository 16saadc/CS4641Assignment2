...
public class BreastCancerTest {
    ...
    private static int inputLayer = 9, hiddenLayer = 5, outputLayer = 1, trainingIterations = 1;
    ...
    public static void main(String[] args) {
        ...
        for (int iter = 1000; iter <= 11000; iter += 2000) {
            ...
            for (int k = 0; k < 5; k++) {
                ...
                oa[1] = new SimulatedAnnealing(1E5, .80, nnop[1]);
                ...
                results += "\nResults for " + oaNames[i] + ": \nCorrectly classified " + correct + " instances." +
                        ...
                        + df.format(100 - (correct / (correct + incorrect) * 100)) + "%\nTraining time: " + df.format(trainingTime)
                ...
                double trial = 100 - (correct / (correct + incorrect) * 100);

                System.out.println(trial);
                System.out.println("Time: " + df.format(trainingTime));
